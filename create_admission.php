...
<html lang="en">
  ...
  <head>
    ...
    <link rel="preload" href="../SMS/forms/css/adminlte.css" as="style" />
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Admission Form</h3></div>
              <div class="col-sm-6">
  ...
  <div class="card p-4 shadow-lg" style="border-radius: 20px;">
    ...
    <form action="admission_insert.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="course_applied" class="form-control" required>
      </div>
      ...
      <div class="mb-3">
        ...
        <textarea name="documents_submitted" class="form-control" rows="2"></textarea>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="number" step="0.01" name="fee_amount" class="form-control">
      </div>
