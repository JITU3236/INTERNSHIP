...
<html lang="en">
  ...
  <div class="container mt-5">
    <div class="card p-4 shadow-lg" style="border-radius: 20px;">
      ...
      <form action="enquiry_insert.php" method="POST">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="date" name="date_of_enquiry" class="form-control" required>
  </div>
