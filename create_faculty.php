...
<html lang="en">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Faculty Form</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Faculty Form</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
  ...
  <div class="card p-4 shadow-lg" style="border-radius: 20px;">
    <h2 class="text-center mb-4 text-dark">Faculty Form</h2>
...
<div class="mb-3">
  ...
  <button type="submit" class="btn btn-primary w-100">Submit Faculty</button>
</form>
